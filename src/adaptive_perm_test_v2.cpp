...
// [[Rcpp::export]]
List run_adaptive_local_permutation_test(List precomp_list, IntegerVector x, int side_code, int h, double alpha, int max_iterations, std::string test_stat_str, List custom_permutation_list) {
  ...
  for (int k = 0; k < custom_permutation_list.size(); k ++) {
  ...
  boost::random::uniform_int_distribution<int> distribution_int(0, upper_value);
