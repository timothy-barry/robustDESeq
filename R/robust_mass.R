...
run_robust_nb_regression <- function(Y_list, x, Z, side = "two_tailed", h = 15L, alpha = 0.1, method = "MASS", size_factors = NULL, theta = NULL, max_iterations = 200000L, adaptive = TRUE) {
  ...
  if (adaptive) {
    ...
    run_permutation_test(precomp_list, x, side_code, B, "compute_score_stat")
  }
}
