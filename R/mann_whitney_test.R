...
#' @return  a data frame containing the results
#' @export
run_mann_whitney_test_permutations <- function(Y_list, x, Z, side = "two_tailed", h = 15L, B = NULL, alpha = 0.1, adaptive_permutation_test = TRUE, max_iterations = 50000L, custom_permutation_list = list()) {
  ...
  if (adaptive_permutation_test) {
    result <- run_adaptive_permutation_test_v2(precomp_list, x, side_code, h, alpha, max_iterations, "compute_mw_test_statistic", custom_permutation_list)
